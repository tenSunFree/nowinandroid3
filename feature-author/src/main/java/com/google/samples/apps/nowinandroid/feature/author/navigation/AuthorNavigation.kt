...
package com.samples.nowinandroid_demo.feature.author.navigation
...
import com.samples.nowinandroid_demo.feature.author.AuthorRoute
...
fun NavGraphBuilder.authorGraph() {
    ...
    composable(route = AuthorDestination.route) {
        AuthorRoute()
    }
}
