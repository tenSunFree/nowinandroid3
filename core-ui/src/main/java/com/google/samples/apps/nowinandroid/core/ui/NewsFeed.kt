...
fun LazyListScope.NewsFeed(
    ...
    when (feedState) {
        ...
        is NewsFeedUiState.Success -> {
            Log.d("", "LazyListScope.NewsFeed, Success, numberOfColumns: $numberOfColumns")
            Log.d("", "LazyListScope.NewsFeed, Success, feed: ${feedState.feed}")
            items(
                ...
                Row(
                    ...
                    Log.d("", "LazyListScope.NewsFeed, Success, numberOfColumns2: $numberOfColumns")
                    repeat(numberOfColumns) { index ->
                        Log.d("", "LazyListScope.NewsFeed, Success, index: $index")
                        Box(
                            ...
                            if (saveableNewsResource != null) {
                                ...
                                NewsResourceCardExpanded(
                                    ...
                                    onToggleBookmark = {
                                        Log.d("", "LazyListScope.NewsFeed, onToggleBookmark")
