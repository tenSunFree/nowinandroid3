...
package com.samples.nowinandroid_demo.core.network.retrofit

import com.samples.nowinandroid_demo.core.network.BuildConfig
...
class RetrofitNiaNetwork @Inject constructor(
    ...
    override suspend fun getNewsResources(): List<NetworkNewsResource> =
        networkApi.getNewsResources().data
